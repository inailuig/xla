...
class IrEmitter : public DfsHloVisitorWithDefault,
 ...
 protected:
  ...
  // note to sel: this is the place where you need ot add stuff
  // to override IrEmitter::DefaultAction in the base class
  // name somehow corresponds to the one with dashes
  Status HandleAllReduceStart(HloInstruction* crs) override;
  Status HandleAllReduceDone(HloInstruction* crs) override;
 ...
 private:
  ...
  Status HandleAllReduceDoneMultipleReplica(HloInstruction* crs);
